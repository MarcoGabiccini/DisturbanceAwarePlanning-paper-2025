...
The closed-loop robust plan described in Sec.~\ref{sec:closed_loop_planning} first finds the nominal plan (4 200 vars, 7.5 s), executes a policy-search step (Step 2, Sec.~\ref{sec:LQR}, 20.5 s), and then solves an additional robust problem with 14 700 variables (Step 3, Sec.~\ref{sec:CLrobustified}, 33 s), giving a total of 41 s.
