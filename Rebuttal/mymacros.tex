...
\newcommand{\bPsimu}{\bPsi^{\mu}}%
\newcommand{\bPsiP}{\bPsi^{\text{P}}}%
\newcommand{\bPsiPCL}{\bPsi^{\text{P,CL}}}%
...
\newcommand{\htbu}{\hat{\tbu}}

\newcommand{\bbmu}{\bar{\bmu}}
\newcommand{\bbu}{\bar{\bu}}
\newcommand{\bbsig}{\bar{\bsig}}
...
\newcommand{\htbB}{\hat{\tbB}}

\newcommand{\hbK}{\hat{\bK}}
\newcommand{\tbK}{\tilde{\bK}}
\newcommand{\htbK}{\hat{\tbK}}
...
\newcommand{\Ipos}[1]{\mathbb{I}_{\geq 0}(#1)}
\newcommand{\Ineg}[1]{\mathbb{I}_{< 0}(#1)}

\newcommand{\SIpos}[1]{\mathbb{SI}_{\geq 0}(#1)}
\newcommand{\SIneg}[1]{\mathbb{SI}_{ < 0}(#1)}
