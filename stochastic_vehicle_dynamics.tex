...
The nonlinear optimal control problem~\eqref{eq:OCPcost} can be discretized by applying a suitable collocation integrator obtaining 
\begin{alignat}{3}
\underset{\bmu_k,\bxi_k, \bu_k, \bP_k,\bz_k}{\text{minimize}} \,
& & & J_k(\bmu_k,\bxi_k, \bu_k, \bP_k) & & \label{eq:DOCPcost} \\
